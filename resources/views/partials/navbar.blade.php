            ...
            <div class="row">
                <div class="col">
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        <div class="logo"><a href="/">MusicStore.</a></div>
                        <nav class="main_nav">
                            <ul>
                        ...
                        <div class="header_extra ml-auto">
                            <div class="shopping_cart">
                                ...
                                <div>Cart @if(Cart::instance('default')->count())<span>({{Cart::instance('default')->count()}})</span> @else <span>(0)</span> @endif</div>
                                </a>
                            </div>
                            <div class="search">
            ...
            <ul class="page_menu_nav menu_mm">
                <li class="page_menu_item has-children menu_mm">
                    ...
                    <ul class="page_menu_selection menu_mm">
                        <li class="page_menu_item menu_mm"><a href="/shop">Shop<i class="fa fa-angle-down"></i></a></li>
                ...
                <li class="page_menu_item has-children menu_mm">
                    ...
                    <ul class="page_menu_selection menu_mm">
                        <li class="page_menu_item menu_mm"><a href="/shop">Category<i class="fa fa-angle-down"></i></a></li>
                        <li class="page_menu_item menu_mm"><a href="/shop">Category<i class="fa fa-angle-down"></i></a></li>
                        <li class="page_menu_item menu_mm"><a href="/shop">Category<i class="fa fa-angle-down"></i></a></li>
                        <li class="page_menu_item menu_mm"><a href="/shop">Category<i class="fa fa-angle-down"></i></a></li>
                    </ul>
