					...
					<div class="order checkout_section">
						...
						<div class="order_list_container">
							...
							<ul class="order_list">
								...
								<li class="d-flex flex-row align-items-center justify-content-start">
								<div class="order_list_title">{{$item->model->name}}</div>
								<div class="order_list_value ml-auto">{{$item->model->presentPrice()}}</div>
								</li>
								@endforeach
								<li class="d-flex flex-row align-items-center justify-content-start">
								...
								<div class="order_list_value ml-auto">{{presentPrice(Cart::total())}}</div> 
								</li>
							</ul>
						</div>
